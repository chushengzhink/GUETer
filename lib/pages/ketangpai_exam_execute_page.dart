...
class _KetangpaiExamExecutePageState extends State<KetangpaiExamExecutePage> {
  ...
  String _questionTitle(Map<String, dynamic> question) => _stripHtml(question['title']?.toString() ?? '');
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SelectableText(title, style: const TextStyle(fontSize: 18)),
