...
class Constant {
  ...
  // 本地账户加密存储
  static const localAccountStoreKey = 'GUEterLocalStore';

  // getDeviceInfo RSA公钥
  static const rsaPublicKey =
...
class EncryptionUtil {
  ...
  /// AES CBC解密
  static String aesCbcDecrypt(String text, String key) {
    final keyObj = encrypt.Key.fromUtf8(key);
  ...
  static String rsaEncrypt(String text, String publicKeyBase64) {
    ...
    final keyLength =
        (publicKey.modulus!.bitLength + 7) ~/ 8; // 1024 位 => 128 字节
